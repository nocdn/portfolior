    ...
    <WritingShell>
      <div className="flex flex-col gap-5 px-5 md:px-0">
        ...
        <p className="text-paragraph">
          I'm a big fan of not giving out my phone number for some random service I've used once.
          Yet my phone only has one SIM slot.
        </p>
        <p className="text-paragraph">
          ...
          why not use it to run an OTP server? (I had a sim card handy, so that was what we were
          going to use).
        </p>
        <p className="text-paragraph">
          I'm comfortable with TypeScript APIs, but the problem arises with the fact that I have
          never written a native Android app before - especially for Android 6.0.0 (released
          September 2015). Thankfully, sillicon valley's golden child - OpenAI, had{" "}
          <a
        ...
        <p className="text-paragraph">
          ...
          incoming SMS messages, and make it accessible as an API without having to manually check
          the phone each time.
        </p>
        <p className="text-paragraph">
        ...
        <p className="text-paragraph">
          ...
          instructions, Codex guided me through creating a new Android Studio project, and wrote
          about 90% of the code needed to make it work. Some small UI and UX refinements later and
          we had a working app, that I could compile and sideload straight into the phone.
        </p>
        <p className="text-paragraph">
