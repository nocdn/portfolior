            ...
            <div className="w-full text-left">
              <div className="font-pp-neue-montreal relative z-10 w-full text-[17px] leading-8 font-medium">
                <div className="relative inline-flex items-center gap-3 whitespace-nowrap">
                  ...
                  <span
                    aria-hidden="true"
                    className="font-inter pointer-events-none absolute top-1/2 left-full z-30 ml-3 -translate-y-1/2 text-[16px] leading-8 font-medium whitespace-nowrap text-gray-500 opacity-0 transition-opacity duration-150 dark:text-gray-400"
                  >
                    [Open]
                  </span>
                </div>
